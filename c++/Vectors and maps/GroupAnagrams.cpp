...
/*
    ...
    2. Maybe we can store each word in the map
        ...
        (ESTA ES LA SOLUCION)
        Due to we are searching anagrams, we can use ASCII of each letter

        2.1. The KEY can be number that we got with the ASCII value of each letter of the word
        2.2. The VALUE will be the vector of the words with that number

    3. So we need first something that give us the KEY

    4. And then just store the VALUEj
